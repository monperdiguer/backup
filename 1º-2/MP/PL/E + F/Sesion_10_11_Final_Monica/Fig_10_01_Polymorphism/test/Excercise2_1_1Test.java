...
class Excercise2_1_1Test {
	...
	void testEarnsTheMost() {
		...
		assertEquals(null, CommissionEmployee.earnsTheMost(null));
		assertEquals(null, CommissionEmployee.earnsTheMost(new CommissionEmployee[0]));
		assertEquals(highest, CommissionEmployee.earnsTheMost(v));
	}
	...
	void testsortAscending() {
		CommissionEmployee.sortAscending(null);
		CommissionEmployee.sortAscending(new CommissionEmployee[0]);
		...
		CommissionEmployee.sortAscending(v1);
		...
		// sort a vector in inverse orderg
		CommissionEmployee.sortAscending(v2);
		...
		CommissionEmployee.sortAscending(v3);
