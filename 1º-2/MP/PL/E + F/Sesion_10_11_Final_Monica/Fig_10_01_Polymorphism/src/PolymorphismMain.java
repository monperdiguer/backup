...
public class PolymorphismMain
{
   public static void main( String[] args) 
   {
      ...
      CommissionEmployee[]  employees ={
    	new CommissionEmployee("Sue", "Jones", "222-22-2222", 10000, .06 ),
      	new BasePlusCommissionEmployee( 
         "Bob", "Lewis", "333-33-3333", 5000, .04, 300 )};  
      
      CommissionEmployee topEarner = CommissionEmployee.earnsTheMost(employees);
      System.out.println("The employee thats earns the most is: " + topEarner);

      System.out.println("Employees in descendent salary orden:");
      CommissionEmployee.sortAscending(employees);
   }
